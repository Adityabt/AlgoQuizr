      ...
      >
        ...
        >
          ...
          <SectionCard
            ...
            subtitle="Update your details and view your account info."
          ...
          <SectionCard
            title="Appearance"
            subtitle="Customise how AlgoQuizr looks for you."
              ...
              {[
                {
                  ...
                  sub: "Remind me to practice if I haven't in 2 days.",
                  value: notifyQuizReminder,
                  set: setNotifyQuizReminder,
                },
                {
                  label: "Weekly report",
                  sub: "Get a summary of your progress every week.",
                  value: notifyWeeklyReport,
                  set: setNotifyWeeklyReport,
                },
                {
                  label: "Tips & resources",
                  sub: "Occasional DSA tips and study resources.",
                  value: notifyTips,
                  set: setNotifyTips,
                },
